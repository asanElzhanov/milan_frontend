...
const authShellCopy = {
  ru: {
    ...
    text: 'Аккаунт Sara Milan хранит историю заказов, адреса и избранные изделия в одном месте.',
  },
  kk: {
    catalog: 'Каталогқа',
    eyebrow: 'Sara Milan Atelier',
    title: 'Жеке гардероб ұсақ бөлшектерден басталады.',
    text: 'Sara Milan аккаунты тапсырыстар тарихын, мекенжайларды және таңдаулы бұйымдарды бір жерде сақтайды.',
  },
  en: {
