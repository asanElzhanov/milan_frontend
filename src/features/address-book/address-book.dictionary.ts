...
export const addressBookDictionary: Record<AppLocale, AddressBookDictionary> = {
  ...
  en: {
    title: 'Addresses',
    subtitle: 'Save delivery addresses for a faster checkout.',
    ...
    emptyDescription: 'Add a delivery address to use it during checkout.',
    ...
    createError: 'Unable to add address',
    updateError: 'Unable to update address',
    deleteError: 'Unable to delete address',
    setDefaultError: 'Unable to set the default address',
    checkoutUsageNote: 'You can select this address during checkout.',
  },
};
