...
export const adaptProductDetail = (response: unknown): ProductDetail | null => {
  ...
  return {
    ...
    composition_ru: toStringOrNull(response.composition_ru),
    composition_kz: toStringOrNull(response.composition_kz),
    composition_en: toStringOrNull(response.composition_en),
    material: toStringOrNull(response.material),
    material_ru: toStringOrNull(response.material_ru),
    material_kz: toStringOrNull(response.material_kz),
    material_en: toStringOrNull(response.material_en),
