...
const cartDictionary = {
  ...
  en: {
    ...
    stockLeft: 'Available',
    updateError: 'Could not update the cart',
    removeError: 'Could not remove the product',
    clearError: 'Could not clear the cart',
    ...
    promoApplyError: 'Could not apply the promo code',
    promoRemoveError: 'Could not remove the promo code',
